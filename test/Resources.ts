...
describe("BondingToken Tests", function () {
  for (const contract of contractNames) {
    describe(`${contract.name} simulation tests`, function () {
      ...
      const exitFees = [0, basis/10000, basis/1000, basis/100, basis/10, basis/2, basis/2 + 1];
      const entryFees = [basis/2 + 1, basis/2, basis/10, basis/100, basis/1000, basis/10000, 0];
